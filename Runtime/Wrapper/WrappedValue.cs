...
namespace Smidgenomics.Unity.Variables
{
	...
	{
		[Serializable] public class Float : WrappedValue<float, SVFloat> { }
		[Serializable] public class Int : WrappedValue<int, SVInt> { }
		[Serializable] public class String : WrappedValue<string, SVString> { }
		[Serializable] public class Vector2 : WrappedValue<UVector2, SVVector2> { }
		[Serializable] public class Vector3 : WrappedValue<UVector3, SVVector3> { }
		[Serializable] public class Color : WrappedValue<UColor, SVColor>
		{
...
namespace Smidgenomics.Unity.Variables
{
	...
	{
		[Serializable]
		public class AnimationCurve : WrappedValue<UnityCurve, SVCurve>
		{
